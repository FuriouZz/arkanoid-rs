...
use fine::graphic::{wgpu, AsTextureView, Texture};
...
impl fine::Scene for TextureExample {
        ...
        Self: Sized,
    {
        ...
        let img = image::load_from_memory(&include_bytes!("texture.png")[..]).unwrap();
        ...
        let resources = binding.bind(|b| match b.binding {
            ...
            // Assign texture view
            2 => Some(wgpu::BindingResource::TextureView(texture.as_view())),
            _ => None,
        });
